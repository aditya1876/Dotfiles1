    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Image(filename='~/.config/qtile/assets/bar/verticalSep.png'),         
            ...
            22,
            margin=[3, 3, 1, 3], #3rd value is 1 because widget_defaults have margin=2 so total gap between bar and window adds to 3
            opacity=0.8,

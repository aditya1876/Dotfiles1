#+TITLE: Adi's GNU Emacs Config
#+AUTHOR: Aditya 
#+DESCRIPTION: Adi's personal Emacs config.
...
;; (require 'app-launchers) ;; Use emacs as a run launcher like dmenu (experimental) - NOT REQUIRED FOR ME
#+end_src
